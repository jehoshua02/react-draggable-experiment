...
/***/ function(module, exports, __webpack_require__) {
	...
	var randomInt = __webpack_require__(182);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { type: 'text', onKeyUp: this._handleKeyUp, placeholder: 'Add Sticky ...' }),
	      this.state.stickies.map(function (sticky) {
	        return React.createElement(Sticky, sticky);
	      })
	    );
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var zIndex = __webpack_require__(7).create();
	...
	var Sticky = React.createClass({
	  ...
	  _handleStart: function _handleStart(event, ui) {
	    console.log('Event: ', event);
	    console.log('Position: ', ui.position);
	    this.setState({ zIndex: zIndex.next() });
	  },

	  _handleDrag: function _handleDrag(event, ui) {
	    console.log('Event: ', event);
	    console.log('Position: ', ui.position);
	  },

	  _handleStop: function _handleStop(event, ui) {
	    console.log('Event: ', event);
	    console.log('Position: ', ui.position);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(40);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(104);
	var ReactStateSetters = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactTransitionChildMapping = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(14);
	var ReactPropTransferer = __webpack_require__(108);
